...
import javax.servlet.*; // apach -> tomcat-9.0.33/lib/servlet-api.jar
						//							jsp-api.jar
...
//[3] 작성한 서블릿을 "컨텍스트/WEB_INF/web.xml"에 등록하거나, 어노테이션을 이용해 등록한다.
...
public class HelloServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		// 응답보낼 문서의 컨텐트타입을 지정하자
		res.setContentType("text/html; charset=UTF-8");
		// res => 브라우저와 연결된 객체(브라우저에 html을 쓰기 위한 스트림을 얻자)
		PrintWriter pw = res.getWriter(); // PrintWriter를 받아
		pw.println("<html>");
